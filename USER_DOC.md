...
3. Just ignore it by clicking `Advanced...` and the `Accept the Risk and Continue` buttons.
	<p align="center">
...
2. Enter either the admin or the normal user credentials located in the `.env` file.
